define(function(require) {
	...
	Stage.Resize  = function(){
		...
		var nWindowWidth = window.innerWidth;
		var nWindowHeight = window.innerHeight;
		///console.log(nWindowWidth);
		//console.log(nWindowHeight);
		// need to work out where our tram lines will be - top and bottom or sides
		var nWindowWidthRatio = nWindowWidth/nWindowHeight;
		
		//console.log("nCanvasWidthRatio: " + nCanvasWidthRatio);
		//console.log("nWindowWidthRatio: " + nWindowWidthRatio);
		//so >1 means wider than taller.  <1 means taller than wider
		
		if(nWindowWidthRatio >= nCanvasWidthRatio){
			//console.log("Window is relatively wider than canvas - tram tracks edges");
			
			//canvas width dictated by canvas height
			$(".stageInner").css("height",nWindowHeight);
			//console.log("height: " + nWindowHeight);
			$(".stageInner").css("width",parseInt(nWindowHeight)*nCanvasWidthRatio);
			//console.log("height: " + parseInt(nWindowHeight)*nCanvasWidthRatio);
			$(".stageInner").css("top",0);
		}else{
			//console.log("Window is relatively taller than canvas - tram tracks top,bottom");
			
			//cavas height dictated by canvas width
			$(".stageInner").css("width",nWindowWidth);
			//console.log("width: " + nWindowWidth);
			$(".stageInner").css("height",nWindowWidth/nCanvasWidthRatio);
			//console.log("height: " + nWindowWidth/nCanvasWidthRatio);
			
			var nYdiff = (nWindowHeight - (nWindowWidth/nCanvasWidthRatio))/2;
			$(".stageInner").css("top",nYdiff);
